...
namespace BugTracker.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly ITrackerEmailSender _ITrackerEmailSender;
        ...
        public RegisterModel(
            ...
            ITrackerEmailSender BugTrackerEmailSender)
        {
            ...
            _logger = logger;
            _ITrackerEmailSender = BugTrackerEmailSender;
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _ITrackerEmailSender.SendEmailAsync(Input.Email, "Confirm your email",
        ...
        private BTUser CreateUser()
        {
            try
            {
                BTUser user = Activator.CreateInstance<BTUser>();
